...
function Home() {
    ...
    return (
        <div className=' h-screen flex items-center justify-center mt-0 w-screen'>
        <div className='bg-[#ffdad7] w-[800px] h-[400px]  m-auto pt-36  rounded-xl shadow-2xl flex justify-between items-center p-20'>
            {/* Left side (Text) */}
            <div className='text-left'>
                <h1 className='text-3xl font-mono font-bold text-black'>
                    Find Your <span className='text-red-500 font-extrabold'>{text}</span> <span className='text-green-800'><Cursor cursorStyle='❤️' /></span>
                </h1>
